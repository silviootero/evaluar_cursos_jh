...
export const UserODeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.userO.delete.question">
        <Translate contentKey="evaluarCursosJhApp.userO.delete.question" interpolate={{ id: userOEntity.userName }}>
