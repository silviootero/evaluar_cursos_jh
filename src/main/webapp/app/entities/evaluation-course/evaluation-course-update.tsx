  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.evaluationCourse.home.createOrEditLabel" data-cy="EvaluationCourseCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.evaluationCourse.home.createOrEditLabel">Create or edit a EvaluationCourse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionOne')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionTwo')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionThree')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionFour')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionFive')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationCourse.cScoreQuestionSix')}
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.evaluationCourse.enrollCourse')}
                type="select"
              >
                <option value="" key="0" />
                {enrollCourses
