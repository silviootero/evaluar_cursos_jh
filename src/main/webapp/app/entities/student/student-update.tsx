  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.student.home.createOrEditLabel">Create or edit a Student</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.student.studentName')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('evaluarCursosJhApp.student.user')}
                type="select"
              >
                <option value="" key="0" />
                {userOS
              ...
              <ValidatedField
                ...
                name="program"
                data-cy="program"
                label={translate('evaluarCursosJhApp.student.program')}
                type="select"
              >
                <option value="" key="0" />
                {academicPrograms
