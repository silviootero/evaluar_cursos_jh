...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.student.delete.question">
        <Translate contentKey="evaluarCursosJhApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
