  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.totalScoreCourse.home.createOrEditLabel" data-cy="TotalScoreCourseCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.home.createOrEditLabel">Create or edit a TotalScoreCourse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreCourse.cAverageOne')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreCourse.cAverageTwo')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreCourse.cAverageThree')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreCourse.cAverageFour')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreCourse.cAverageFive')}
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.totalScoreCourse.academicPeriod')}
                type="select"
              >
                <option value="" key="0" />
                {academicPeriods
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('evaluarCursosJhApp.totalScoreCourse.course')}
                type="select"
              >
                <option value="" key="0" />
                {courses
              ...
              <ValidatedField
                ...
                name="profesor"
                data-cy="profesor"
                label={translate('evaluarCursosJhApp.totalScoreCourse.profesor')}
                type="select"
              >
                <option value="" key="0" />
                {profesors
