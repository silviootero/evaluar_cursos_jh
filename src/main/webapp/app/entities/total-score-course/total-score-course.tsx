  ...
  return (
    <div>
      <h2 id="total-score-course-heading" data-cy="TotalScoreCourseHeading">
        <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.home.title">Total Score Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.home.createLabel">Create new Total Score Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {totalScoreCourseList && totalScoreCourseList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.cAverageOne">C Average One</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.cAverageTwo">C Average Two</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.cAverageThree">C Average Three</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.cAverageFour">C Average Four</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.cAverageFive">C Average Five</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.academicPeriod">Academic Period</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.course">Course</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.profesor">Profesor</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.home.notFound">No Total Score Courses found</Translate>
            </div>
          )
        )}
      </div>
