...
export const TotalScoreCourseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.totalScoreCourse.delete.question">
        <Translate contentKey="evaluarCursosJhApp.totalScoreCourse.delete.question" interpolate={{ id: totalScoreCourseEntity.id }}>
