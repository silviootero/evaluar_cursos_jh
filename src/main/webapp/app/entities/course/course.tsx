  ...
  return (
    <div>
      <h2 id="course-heading" data-cy="CourseHeading">
        <Translate contentKey="evaluarCursosJhApp.course.home.title">Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.course.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/course/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.course.home.createLabel">Create new Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseList && courseList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.course.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.course.courseName">Course Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.course.home.notFound">No Courses found</Translate>
            </div>
          )
        )}
      </div>
