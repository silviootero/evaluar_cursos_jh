...
export const EvaluationProfesorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.evaluationProfesor.delete.question">
        <Translate contentKey="evaluarCursosJhApp.evaluationProfesor.delete.question" interpolate={{ id: evaluationProfesorEntity.id }}>
