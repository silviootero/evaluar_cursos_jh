  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.evaluationProfesor.home.createOrEditLabel" data-cy="EvaluationProfesorCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.evaluationProfesor.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionOne')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionTwo')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionThree')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionFour')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionFive')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.evaluationProfesor.pScoreQuestionSix')}
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.evaluationProfesor.enrollCourse')}
                type="select"
              >
                <option value="" key="0" />
                {enrollCourses
