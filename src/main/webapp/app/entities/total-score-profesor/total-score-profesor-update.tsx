  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.totalScoreProfesor.home.createOrEditLabel" data-cy="TotalScoreProfesorCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreProfesor.pAverageOne')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreProfesor.pAverageTwo')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreProfesor.pAverageThree')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreProfesor.pAverageFour')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.totalScoreProfesor.pAverageFive')}
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.totalScoreProfesor.academicPeriod')}
                type="select"
              >
                <option value="" key="0" />
                {academicPeriods
