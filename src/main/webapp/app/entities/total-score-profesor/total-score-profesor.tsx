  ...
  return (
    <div>
      <h2 id="total-score-profesor-heading" data-cy="TotalScoreProfesorHeading">
        <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.home.title">Total Score Profesors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.home.createLabel">Create new Total Score Profesor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {totalScoreProfesorList && totalScoreProfesorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.pAverageOne">P Average One</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.pAverageTwo">P Average Two</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.pAverageThree">P Average Three</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.pAverageFour">P Average Four</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.pAverageFive">P Average Five</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.academicPeriod">Academic Period</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.home.notFound">No Total Score Profesors found</Translate>
            </div>
          )
        )}
      </div>
