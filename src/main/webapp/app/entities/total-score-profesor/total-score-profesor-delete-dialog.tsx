...
export const TotalScoreProfesorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.totalScoreProfesor.delete.question">
        <Translate contentKey="evaluarCursosJhApp.totalScoreProfesor.delete.question" interpolate={{ id: totalScoreProfesorEntity.id }}>
