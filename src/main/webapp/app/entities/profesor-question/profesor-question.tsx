  ...
  return (
    <div>
      <h2 id="profesor-question-heading" data-cy="ProfesorQuestionHeading">
        <Translate contentKey="evaluarCursosJhApp.profesorQuestion.home.title">Profesor Questions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.profesorQuestion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/profesor-question/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.profesorQuestion.home.createLabel">Create new Profesor Question</Translate>
          </Link>
        </div>
      </h2>
        ...
        {profesorQuestionList && profesorQuestionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.profesorQuestion.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.profesorQuestion.profesorQuestion">Profesor Question</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.profesorQuestion.home.notFound">No Profesor Questions found</Translate>
            </div>
          )
        )}
      </div>
