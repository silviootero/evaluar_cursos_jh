...
export const ProfesorQuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.profesorQuestion.delete.question">
        <Translate contentKey="evaluarCursosJhApp.profesorQuestion.delete.question" interpolate={{ id: profesorQuestionEntity.id }}>
