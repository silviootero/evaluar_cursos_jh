  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.profesorQuestion.home.createOrEditLabel" data-cy="ProfesorQuestionCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.profesorQuestion.home.createOrEditLabel">Create or edit a ProfesorQuestion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.profesorQuestion.profesorQuestion')}
