  ...
  return (
    <div>
      <h2 id="role-heading" data-cy="RoleHeading">
        <Translate contentKey="evaluarCursosJhApp.role.home.title">Roles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.role.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/role/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.role.home.createLabel">Create new Role</Translate>
          </Link>
        </div>
      </h2>
        ...
        {roleList && roleList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.role.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.role.roleName">Role Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.role.home.notFound">No Roles found</Translate>
            </div>
          )
        )}
      </div>
