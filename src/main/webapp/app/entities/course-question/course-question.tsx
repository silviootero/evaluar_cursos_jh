  ...
  return (
    <div>
      <h2 id="course-question-heading" data-cy="CourseQuestionHeading">
        <Translate contentKey="evaluarCursosJhApp.courseQuestion.home.title">Course Questions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.courseQuestion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/course-question/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.courseQuestion.home.createLabel">Create new Course Question</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseQuestionList && courseQuestionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.courseQuestion.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.courseQuestion.courseQuestion">Course Question</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.courseQuestion.home.notFound">No Course Questions found</Translate>
            </div>
          )
        )}
      </div>
