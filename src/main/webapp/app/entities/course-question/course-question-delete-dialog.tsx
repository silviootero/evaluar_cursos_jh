...
export const CourseQuestionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.courseQuestion.delete.question">
        <Translate contentKey="evaluarCursosJhApp.courseQuestion.delete.question" interpolate={{ id: courseQuestionEntity.id }}>
