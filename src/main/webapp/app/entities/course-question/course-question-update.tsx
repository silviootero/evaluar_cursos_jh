  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.courseQuestion.home.createOrEditLabel" data-cy="CourseQuestionCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.courseQuestion.home.createOrEditLabel">Create or edit a CourseQuestion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.courseQuestion.courseQuestion')}
