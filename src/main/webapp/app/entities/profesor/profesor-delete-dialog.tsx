...
export const ProfesorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.profesor.delete.question">
        <Translate contentKey="evaluarCursosJhApp.profesor.delete.question" interpolate={{ id: profesorEntity.id }}>
