  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.profesor.home.createOrEditLabel" data-cy="ProfesorCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.profesor.home.createOrEditLabel">Create or edit a Profesor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.profesor.profesorName')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('evaluarCursosJhApp.profesor.user')}
                type="select"
              >
                <option value="" key="0" />
                {userOS
