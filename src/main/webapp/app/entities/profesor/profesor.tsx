  ...
  return (
    <div>
      <h2 id="profesor-heading" data-cy="ProfesorHeading">
        <Translate contentKey="evaluarCursosJhApp.profesor.home.title">Profesors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.profesor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/profesor/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.profesor.home.createLabel">Create new Profesor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {profesorList && profesorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.profesor.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.profesor.profesorName">Profesor Name</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.profesor.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.profesor.home.notFound">No Profesors found</Translate>
            </div>
          )
        )}
      </div>
