  ...
  return (
    <div>
      <h2 id="enroll-course-heading" data-cy="EnrollCourseHeading">
        <Translate contentKey="evaluarCursosJhApp.enrollCourse.home.title">Enroll Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.enrollCourse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/enroll-course/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.enrollCourse.home.createLabel">Create new Enroll Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {enrollCourseList && enrollCourseList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.periodAcademic">Period Academic</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.isEvaluated">Is Evaluated</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.student">Student</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.academicProgram">Academic Program</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.profesor">Profesor</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.enrollCourse.academicPeriod">Academic Period</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.enrollCourse.home.notFound">No Enroll Courses found</Translate>
            </div>
          )
        )}
      </div>
