  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.enrollCourse.home.createOrEditLabel" data-cy="EnrollCourseCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.enrollCourse.home.createOrEditLabel">Create or edit a EnrollCourse</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.enrollCourse.periodAcademic')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.enrollCourse.isEvaluated')}
              ...
              <ValidatedField
                ...
                name="student"
                data-cy="student"
                label={translate('evaluarCursosJhApp.enrollCourse.student')}
                type="select"
              >
                <option value="" key="0" />
                {students
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.enrollCourse.academicProgram')}
                type="select"
              >
                <option value="" key="0" />
                {academicPrograms
              ...
              <ValidatedField
                ...
                name="profesor"
                data-cy="profesor"
                label={translate('evaluarCursosJhApp.enrollCourse.profesor')}
                type="select"
              >
                <option value="" key="0" />
                {profesors
              ...
              <ValidatedField
                ...
                label={translate('evaluarCursosJhApp.enrollCourse.academicPeriod')}
                type="select"
              >
                <option value="" key="0" />
                {academicPeriods
