...
export const AcademicPeriodDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="evaluarCursosJhApp.academicPeriod.delete.question">
        <Translate contentKey="evaluarCursosJhApp.academicPeriod.delete.question" interpolate={{ id: academicPeriodEntity.id }}>
