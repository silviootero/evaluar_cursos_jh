  ...
  return (
    <div>
      <h2 id="academic-period-heading" data-cy="AcademicPeriodHeading">
        <Translate contentKey="evaluarCursosJhApp.academicPeriod.home.title">Academic Periods</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.academicPeriod.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/academic-period/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.academicPeriod.home.createLabel">Create new Academic Period</Translate>
          </Link>
        </div>
      </h2>
        ...
        {academicPeriodList && academicPeriodList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.academicPeriod.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.academicPeriod.initPeriod">Init Period</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.academicPeriod.finishPeriod">Finish Period</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.academicPeriod.home.notFound">No Academic Periods found</Translate>
            </div>
          )
        )}
      </div>
