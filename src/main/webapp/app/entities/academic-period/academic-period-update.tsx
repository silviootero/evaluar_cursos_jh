  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.academicPeriod.home.createOrEditLabel" data-cy="AcademicPeriodCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.academicPeriod.home.createOrEditLabel">Create or edit a AcademicPeriod</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.academicPeriod.initPeriod')}
              ...
              />
              <ValidatedField
                label={translate('evaluarCursosJhApp.academicPeriod.finishPeriod')}
