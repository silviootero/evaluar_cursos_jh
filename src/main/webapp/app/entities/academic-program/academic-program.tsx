  ...
  return (
    <div>
      <h2 id="academic-program-heading" data-cy="AcademicProgramHeading">
        <Translate contentKey="evaluarCursosJhApp.academicProgram.home.title">Academic Programs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosJhApp.academicProgram.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/academic-program/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="evaluarCursosJhApp.academicProgram.home.createLabel">Create new Academic Program</Translate>
          </Link>
        </div>
      </h2>
        ...
        {academicProgramList && academicProgramList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.academicProgram.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="evaluarCursosJhApp.academicProgram.programName">Program Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosJhApp.academicProgram.home.notFound">No Academic Programs found</Translate>
            </div>
          )
        )}
      </div>
