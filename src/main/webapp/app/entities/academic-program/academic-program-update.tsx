  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="evaluarCursosJhApp.academicProgram.home.createOrEditLabel" data-cy="AcademicProgramCreateUpdateHeading">
            <Translate contentKey="evaluarCursosJhApp.academicProgram.home.createOrEditLabel">Create or edit a AcademicProgram</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('evaluarCursosJhApp.academicProgram.programName')}
