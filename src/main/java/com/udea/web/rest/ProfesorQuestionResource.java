...
import com.udea.domain.ProfesorQuestion;
import com.udea.repository.ProfesorQuestionRepository;
...
/**
 * REST controller for managing {@link com.udea.domain.ProfesorQuestion}.
 */
@RestController
@RequestMapping("/api")
@Transactional
