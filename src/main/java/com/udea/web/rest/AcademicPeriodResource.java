...
import com.udea.domain.AcademicPeriod;
import com.udea.repository.AcademicPeriodRepository;
...
/**
 * REST controller for managing {@link com.udea.domain.AcademicPeriod}.
 */
@RestController
@RequestMapping("/api")
@Transactional
